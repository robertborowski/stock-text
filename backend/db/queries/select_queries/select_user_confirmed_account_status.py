...
def select_user_confirmed_account_status_function(connection_postgres, cursor, uuid_to_search):
  ...
  try:
    ...
    if confirm_status_email == False:
      confirm_status_email = 'Email not confirmed! You will not receive Symbol News notifications until your email is confirmed.'
    else:
    ...
    if confirm_status_phone_number == False:
      confirm_status_phone_number = 'Phone number not confirmed! You will not receive Symbol News notifications until your phone number is confirmed.'
    else:
