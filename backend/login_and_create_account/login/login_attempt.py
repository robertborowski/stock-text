...
def login_attempt_function():
  ...
  if session and 'logged_in_user_email' in session and session.get('logged_in_user_email') != 'none' and session.get('logged_in_user_email') != "temp_placeholder_email@symbolnews.com" and session.get('logged_in_user_email') != None:
